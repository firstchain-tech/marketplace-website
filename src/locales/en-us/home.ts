const home = {
  ...
  'home.about.list.5':
    'There is currently an oversupply of low-value NFTs, and with a forecast that 90% of NFTs will lose value in the next few years, Collex will focus on the most valuable 10%, focusing on the rarest and most exclusive NFT works.',
  'home.about.list.6': '2. Work innovation',
  'home.about.list.7':
    'At present, NFT has only scratched the surface in adding value to holders. How to empower requires more innovation. Collex will integrate AR elements in the near future to enhance the relationship between physical assets and works, and realize value and interactivity.',
