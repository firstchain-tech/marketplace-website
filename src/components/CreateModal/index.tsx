...
import { Input, Button, Form, Col, Row, Upload, Select, message, Image, Modal, Divider, InputNumber } from 'antd'
        ...
        <Col span={18} lg={{ span: 16 }} xl={{ span: 12 }}>
          ...
          >
            ...
            <Form.Item label={t('create.from4.label')} name="describe">
              <Input.TextArea autoSize={{ minRows: 6, maxRows: 8 }} maxLength={200} showCount placeholder={t('create.from4.placeholder')} />
            </Form.Item>
